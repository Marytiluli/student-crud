 ...
 *
 * This build file configures the main application module with:
 * - Android SDK versions and compilation settings
 * - Jetpack Compose setup with Material Design 3
 * - Room Database with KSP code generation
 * - Kotlin Coroutines and Flow
 * - Testing dependencies (JUnit, Espresso, Room Testing)
